        ...
        >
          ...
          {[
            ...
            },
            {
              title: 'PRACTICE',
              content:
                'Το μοντέλο των οκτώ βημάτων ξεκινά με τον καθορισμό του προβλήματος και ρεαλιστικών στόχων. Στη συνέχεια, δημιουργούνται εναλλακτικές λύσεις, αξιολογούνται οι συνέπειές τους, και επιλέγεται η καλύτερη λύση η οποία εφαρμόζεται με σαφές χρονοδιάγραμμα, ενώ η πρόοδος παρακολουθείται συνεχώς.',
            },
            {
              title: 'SMART',
              content:
