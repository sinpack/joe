...
const categories = [
  ...
  'Αλλαγή επαγγελματικής καριέρας',
...
const CategoryList: React.FC = () => {
  return (
    <div className="flex flex-col w-full space-y-5">
      ...
      <ul className="flex flex-col self-center rounded-xl border border-gray-300 border-b-0 shadow-xl shadow-zinc-700 drop-shadow-xl">
        {categories.map((category, index) => (
          ...
          >
            ...
            <p className="ml-2 leading-tight tracking-tight font-medium text-sm md:text-lg">
              {category}
            </p>
          </li>
        ))}
