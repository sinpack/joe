        ...
        >
          <div
            className={clsx({
              ...
              'default-transition hover:bg-gray-300': !isActive,
              'text-blue-500': isActive,
            })}
          >
            <p
              className={clsx({
                'default-transition relative default-transition before:transition-[width] before:ease-in-out before:duration-700 before:absolute before:bg-green-300 before:origin-center before:h-[1px] before:w-0 hover:before:w-[50%] before:bottom-0 before:left-[50%] after:transition-[width] after:ease-in-out after:duration-700 after:absolute after:bg-green-300 after:origin-center after:h-[1px] after:w-0 hover:after:w-[50%] after:bottom-0 after:right-[50%]':
                  !isActive,
                'text-blue-500': isActive,
              })}
            >
