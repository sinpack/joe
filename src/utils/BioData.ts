...
const bioData: BioDataItem[] = [
  {
    title: 'ΒΙΟΓΡΑΦΙΚΟ',
    description:
      'Ονομάζομαι Γεώργιος Αντωνόπουλος και γεννήθηκα το 1987, στην Πάτρα, όπου και κατοικώ. Από την παιδική μου ηλικία άρχισα να αναπτύσσω έντονο ενδιαφέρον για διάφορους τομείς των Τεχνών και των Επιστημών. Καθώς μεγάλωνα, η ανάγκη μου να επεκτείνω το μορφωτικό μου επίπεδο καθώς και να εξερευνήσω καινούργια γνωσιακά πεδία, με ώθησε στο να ασχοληθώ - τόσο σε ερασιτεχνικό όσο και σε ακαδημαϊκό επίπεδο - με τη Μουσική, την Ψυχολογία, τις Ξένες Γλώσσες, την Πληροφορική και τις Ανθρωπιστικές Επιστήμες. Είμαι απόφοιτος Τριτοβάθμιας Εκπαίδευσης, του προγράμματος «Σπουδές στον Ευρωπαϊκό Πολιτισμό», μέσω του οποίου ήρθα σε επαφή με επιστημονικά πεδία όπως: Οικονομική και Κοινωνική Ιστορία, Φιλοσοφία, Επιστήμες και Τέχνες, Ανθρωπογεωγραφία, Μεσαιωνικός και Δυτικός Κόσμος, Εξέλιξη Και Διακυβέρνηση Της Ευρωπαϊκής Ένωσης κ.ά. . Διαθέτω άδεια διδασκαλίας της αγγλικής γλώσσας και έχω ολοκληρώσει επιτυχώς σεμινάριο σχετικά με τις μαθησιακές δυσκολίες. Ανά τα χρόνια, έχω εργαστεί σε πολλούς και διάφορους τομείς της αγοράς εργασίας, από τους οποίους έχω αποκομίσει πολύτιμη γνώση και εμπειρία. Ενδεικτικά, μπορώ να αναφέρω χειρωνακτικές εργασίες, ενισχυτική διδασκαλία σε μαθητές, ραδιοφωνικός παραγωγός, τεχνικός/πωλητής σε κατάστημα μουσικών οργάνων και Account Manager σε πολυεθνική εταιρεία τηλεπικοινωνιών. Στον ελεύθερο χρόνο μου, απολαμβάνω να παίζω και να ακούω μουσική, να αθλούμαι, να έρχομαι σε επαφή με τη φύση και τα ζώα και να συγγράφω. Η προσωπική και η επαγγελματική μου ανάπτυξη αποτελούν για εμένα ενθουσιώδη κίνητρα και αναζητώ συνεχώς καινούργιες ευκαιρίες για μάθηση και αυτοεξέλιξη.',
    color: '#A9D6E5',
  },
  {
