...
const holisticData: HolisticDataProps[] = [
  ...
  },
  {
    ...
    descriptions: [
      'Είναι βασισμένη στην προσωποκεντρική προσέγγιση του ανθρωπιστικού ψυχολόγου Carl Rogers. Αυτή η προσέγγιση εδράζεται στην πεποίθηση ότι τα άτομα έχουν την ικανότητα να πραγματοποιήσουν το δυναμικό τους για ανάπτυξη και αλλαγή. Ο Rogers έδινε έμφαση στην ενσυναίσθηση, την άνευ όρων θετική αποδοχή και την αυθεντικότητα στη θεραπευτική σχέση. Πίστευε ότι η παροχή ενός υποστηρικτικού και μη επικριτικού περιβάλλοντος μπορεί να βοηθήσει τους πελάτες να εξερευνήσουν τα συναισθήματά τους και τις εμπειρίες τους, οδηγώντας στην προσωπική ανάπτυξη και την αποδοχή του εαυτού. Συνολικά, η προσέγγιση του Rogers επικεντρωνόταν στο να ενδυναμώσει τα άτομα να ανακαλύψουν τις δικές τους λύσεις και να επιφέρουν θετικές αλλαγές στη ζωή τους. Ο κύριος σκοπός μου είναι να σου παρέχω τα κατάλληλα εργαλεία, τα οποία θα σε βοηθήσουν να ανακαλύψεις καλύτερα τον εαυτό σου και να αξιοποιήσεις τις πραγματικές σου δυνατότητες.',
    ],
    color: '#A8C3A7',
  },
  {
    title: 'ΣΥΝΕΔΡΙΕΣ',
    descriptions: [
      'Οι συνεδρίες έχουν διάρκεια περίπου 50 λεπτά και πραγματοποιούνται είτε δια ζώσης** ή online μέσω {SKYPE_LINK}. Η συχνότητά τους μπορεί να είναι εβδομαδιαία ή κάθε 2 εβδομάδες. Στις συνεδρίες μπορούμε να χρησιμοποιήσουμε διάφορες υπηρεσίες/θεραπείες, προσαρμοσμένες στις ανάγκες του πελάτη.',
    ],
    color: '#C4B7CB',
    footer:
