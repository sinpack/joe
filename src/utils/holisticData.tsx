...
const holisticData: HolisticDataProps[] = [
  ...
  },
  {
    title: 'ΣΥΝΕΔΡΙΕΣ',
    descriptions: [
      'Οι συνεδρίες έχουν διάρκεια περίπου 50 λεπτά και πραγματοποιούνται είτε δια ζώσης ή online. Η συχνότητά τους μπορεί να είναι εβδομαδιαία ή κάθε 2 εβδομάδες. Στις συνεδρίες μπορούμε να χρησιμοποιήσουμε διάφορες υπηρεσίες/θεραπείες, προσαρμοσμένες στις ανάγκες του πελάτη.',
    ],
    color: '#C4B7CB',
  },
];
