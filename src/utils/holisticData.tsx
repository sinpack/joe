...
const holisticData: HolisticDataProps[] = [
  ...
  },
  {
    ...
    descriptions: [
      'Είναι βασισμένη στην προσωποκεντρική προσέγγιση του ανθρωπιστικού ψυχολόγου Carl Rogers. Αυτό σημαίνει, εν ολίγοις, ότι αντιμετωπίζω τον κάθε άνθρωπο ως μία ξεχωριστή προσωπικότητα, που διαθέτει μοναδικές εμπειρίες και την δική του κοσμοαντίληψη. Ο κύριος σκοπός μου είναι να σου παρέχω τα κατάλληλα εργαλεία, τα οποία θα σε βοηθήσουν να ανακαλύψεις καλύτερα τον εαυτό σου, τις πραγματικές σου δυνάμεις και ικανότητες, ώστε να ζήσεις μία όμορφη ζωή.',
    ],
    color: '#A8C3A7',
  },
  {
